...
namespace Uspeak.Infrastructure
{
    ...
    public class Logger : NLog.ILogger, Microsoft.Extensions.Logging.ILogger
    {
        ...
        public string Name => "Looger";

        public LogFactory Factory => null;

        public event EventHandler<EventArgs> LoggerReconfigured;

        public void Debug(object value) => Write(value.ToString());

        public void Debug(IFormatProvider formatProvider, object value) => Write(value.ToString());

        public void Debug(string message, object arg1, object arg2) => Write(message);

        public void Debug(string message, object arg1, object arg2, object arg3) => Write(message);

        public void Debug(IFormatProvider formatProvider, string message, bool argument) => Write(message);

        public void Debug(string message, bool argument) => Write(message);

        public void Debug(IFormatProvider formatProvider, string message, char argument) => Write(message);

        public void Debug(string message, char argument) => Write(message);
        public void Debug(IFormatProvider formatProvider, string message, byte argument) => Write(message);

        public void Debug(string message, byte argument) => Write(message);

        public void Debug(IFormatProvider formatProvider, string message, string argument) => Write(message);
        public void Debug(string message, string argument) => Write(message);

        public void Debug(IFormatProvider formatProvider, string message, int argument) => Write(message);

        public void Debug(string message, int argument) => Write(message);
        public void Debug(IFormatProvider formatProvider, string message, long argument) => Write(message);

        public void Debug(string message, long argument) => Write(message);

        public void Debug(IFormatProvider formatProvider, string message, float argument) => Write(message);

        public void Debug(string message, float argument) => Write(message);
        public void Debug(IFormatProvider formatProvider, string message, double argument) => Write(message);
        public void Debug(string message, double argument) => Write(message);
        public void Debug(IFormatProvider formatProvider, string message, decimal argument) => Write(message);
        public void Debug(string message, decimal argument) => Write(message);
        public void Debug(IFormatProvider formatProvider, string message, object argument) => Write(message);

        public void Debug(string message, object argument) => Write(message);

        public void Debug(IFormatProvider formatProvider, string message, sbyte argument) => Write(message);

        public void Debug(string message, sbyte argument) => Write(message);
        public void Debug(IFormatProvider formatProvider, string message, uint argument) => Write(message);

        public void Debug(string message, uint argument) => Write(message);

        public void Debug(IFormatProvider formatProvider, string message, ulong argument) => Write(message);

        public void Debug(string message, ulong argument) => Write(message);
        ...
        public void Debug(Exception exception, [Localizable(false)] string message) => Write(message);

        public void Debug(Exception exception, [Localizable(false)] string message, params object[] args) => Write(message);
        public void Debug(Exception exception, IFormatProvider formatProvider, [Localizable(false)] string message, params object[] args) => Write(message);

        public void Debug(IFormatProvider formatProvider, [Localizable(false)] string message, params object[] args) => Write(message);

        public void Debug([Localizable(false)] string message) => Write(message);

        public void Debug([Localizable(false)] string message, params object[] args) => Write(message);
        ...
        public void Trace(object value) => Write(value.ToString(), "Trace");
        ...
        public void Trace(Exception exception, [Localizable(false)] string message) => Write(message, "Trace");

        public void Trace(Exception exception, [Localizable(false)] string message, params object[] args) => Write(message, "Trace");
        ...
        public void Trace([Localizable(false)] string message) => Write(message, "Trace");

        public void Trace([Localizable(false)] string message, params object[] args) => Write(message, "Trace");

        public void Trace([Localizable(false)] string message, Exception exception) => Write(message, "Trace");

        public void Trace<TArgument>(IFormatProvider formatProvider, [Localizable(false)] string message, TArgument argument) => Write(message, "Trace");

        public void Trace<TArgument>([Localizable(false)] string message, TArgument argument) => Write(message, "Trace");
